...
contentEval(function () {
    ...
    EF.init_pop = function () {
        ...
        html += '<div><input id="rpc-url" type="text" style="width:200px;background:rgba(0,0,0,0);" onFocus=\"this.value=\'\'\" value="http://routelive.org:6800/jsonrpc"></input></div><div id="rpc" class="com_opt_btn"><span><em>RPC</em></span></div>';
        html += '</div>';
